...
def generate_bench_abcdefg(num_loops=20):
...
if __name__ == '__main__':
    ...
    with open('tests/bench_ABCDEFG.s', 'w') as f:
        f.write(generate_bench_abcdefg())

    print('SUCCESS: Generated tests/bench_ABCDEFG.s')